...
export async function runPassthroughTests(): Promise<PassthroughRunSummary> {
  ...
  const childEnv: NodeJS.ProcessEnv = {
    ...
    E2E_BACKEND_URL:
      process.env.E2E_BACKEND_URL ?? process.env.SCOPELY_BASE_URL ?? process.env.SCOPELY_URL,
    E2E_FRONTEND_URL:
      process.env.E2E_FRONTEND_URL ?? process.env.SCOPELY_BASE_URL ?? process.env.SCOPELY_URL,
