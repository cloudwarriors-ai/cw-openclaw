      ...
      const fallbackResult = await runWithModelFallback({
        ...
        run: (provider, model) => {
          ...
          return runEmbeddedPiAgent({
            ...
            channelSlug: params.followupRun.run.channelSlug,
            isSupport: params.followupRun.run.isSupport,
            defaultMemoryScope: params.followupRun.run.defaultMemoryScope,
            allowAllCustomersMemoryScope: params.followupRun.run.allowAllCustomersMemoryScope,
            excludeMemorySlugs: params.followupRun.run.excludeMemorySlugs,
            images: params.opts?.images,
